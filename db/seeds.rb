...
Score.create [
  ...
  # => CS 221
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o3.id, type: "BS", score: 3.73},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o4.id, type: "BS", score: 3.80},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o5.id, type: "BS", score: 3.72},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o3.id, type: "BA", score: 3.73},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o4.id, type: "BA", score: 3.80},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c221.id, "fall", 2014).id, outcome_id: o5.id, type: "BA", score: 3.72},
  # 300
  # => CS 305
  ...
  # => FALL 2013
  # => CS 202
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.34},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.34},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.34},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.24},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 2.83},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 2.83},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 2.83},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c202.id, "fall", 2013).id, outcome_id: o4.id, type: "BA", score: 2.83},
  # => CS 215
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.05},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.1},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.12},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o6.id, type: "BS", score: 3.2},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o8.id, type: "BS", score: 3.2},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 2.81},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 3.43},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o6.id, type: "BA", score: 3.25},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c215.id, "fall", 2013).id, outcome_id: o8.id, type: "BA", score: 3.25},
  # => CS 220
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 2.5},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 1.5},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 1.55},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 2.83},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 2.67},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c220.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 2.92},
  # 300
  # => CS 305
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 2.78},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 2.98},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o4.id, type: "BA", score: 2.92},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o5.id, type: "BA", score: 3.26},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o6.id, type: "BA", score: 3.06},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c305.id, "fall", 2013).id, outcome_id: o8.id, type: "BA", score: 3.38},
  # => CS 306
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 2.9},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.2},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 2.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 2.8},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 2.9},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c306.id, "fall", 2013).id, outcome_id: o5.id, type: "BA", score: 2.6},
  # => CS 311
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.22},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.19},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.17},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.32},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.15},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 3.19},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 3.16},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 3.13},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o4.id, type: "BA", score: 3.16},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c311.id, "fall", 2013).id, outcome_id: o5.id, type: "BA", score: 2.96},
  # => CS 320
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.3},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.4},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.6},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o1.id, type: "BA", score: 3.7},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o2.id, type: "BA", score: 3.6},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c320.id, "fall", 2013).id, outcome_id: o3.id, type: "BA", score: 3.7},
  # => CS 330
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o1.id, type: "BS", score: 3.47},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o2.id, type: "BS", score: 3.5},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o3.id, type: "BS", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o4.id, type: "BS", score: 3.33},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o1.id, type: "BA", score: 3.2},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o2.id, type: "BA", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o3.id, type: "BA", score: 3.33},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c330.id, "fall", 2014).id, outcome_id: o4.id, type: "BA", score: 3.0},
  # => CS 399
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o6.id, type: "BS", score: 4.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o7.id, type: "BS", score: 4.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o8.id, type: "BS", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o9.id, type: "BS", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o6.id, type: "BA", score: 4.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o7.id, type: "BA", score: 4.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o8.id, type: "BA", score: 3.0},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c399.id, "fall", 2013).id, outcome_id: o9.id, type: "BA", score: 3.0},
  # 400
  # => CS 408
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.28},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.25},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.28},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.1},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.12},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c408.id, "fall", 2013).id, outcome_id: o6.id, type: "BS", score: 3.0},
  # => CS 430
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c430.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.15},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c430.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.23},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c430.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.18},
  # => CS 441
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.15},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 2.88},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.25},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.3},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o6.id, type: "BS", score: 3.25},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c441.id, "fall", 2013).id, outcome_id: o8.id, type: "BS", score: 3.38},
  # => CS 455
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 2.1},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 1},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 2.75},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 2.25},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 2.19},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c455.id, "fall", 2013).id, outcome_id: o7.id, type: "BS", score: 3.25},
  # => CS 487
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o1.id, type: "BS", score: 3.74},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o2.id, type: "BS", score: 3.35},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.83},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.57},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.84},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o7.id, type: "BS", score: 3.62},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c487.id, "fall", 2013).id, outcome_id: o8.id, type: "BS", score: 3.48},
  # => CS 498
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o3.id, type: "BS", score: 3.38},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o4.id, type: "BS", score: 3.38},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o5.id, type: "BS", score: 3.3},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o6.id, type: "BS", score: 3.31},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o7.id, type: "BS", score: 3.21},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o8.id, type: "BS", score: 3.31},
  {scheduled_course_id: ScheduledCourse.find_by_course_id_and_semester_and_year!(c498.id, "fall", 2013).id, outcome_id: o9.id, type: "BS", score: 3.21},
